...
public class Chart_MonthlyFragment extends Fragment {

    String email;
    int card_pos;
    public Chart_MonthlyFragment(){}
    public Chart_MonthlyFragment(int pos) {
        this.card_pos = pos;
        Log.d("id inside chart monthly",Integer.toString(card_pos));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_chart__monthly, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        LineChart lineChart;
        lineChart = view.findViewById(R.id.chart_2);
                        ...
                        for(int i=-29; i<1; i++){
                            ...
                            switch (card_pos){
                                ...
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    if(snapshot.child("").child((String) dateCharSequence).child("Sleep_Duration").exists()){
                                        int a = i+29;
